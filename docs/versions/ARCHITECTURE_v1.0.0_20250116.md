...
| AI Explore | `/explore` | 🚧 待实现 | 语义搜索、文档预览、标签分类 |
| My Library | `/library` | 🚧 待实现 | 文档上传、URL导入、文件夹管理 |
...
│   │       │   ├── auth.py
│   │       │   ├── chat.py        # AI Ask API
│   │       │   ├── explore.py     # AI Explore API (待实现)
│   │       │   ├── library.py     # My Library API (待实现)
│   │       │   └── ...
│   │       ├── db/
│   │       │   └── models.py      # 数据库模型
│   │       └── main.py            # 应用入口
...
- [ ] Phase 2: AI Explore (语义搜索)
- [ ] Phase 3: My Library (文档管理)
...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| 1.0.0 | 2025-01-16 | 初始架构文档，完成 Phase 1-2 |
