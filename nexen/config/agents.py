...
class Module1Config:
    ...
    generator_model: str = "google/gemini-2.0-flash"
    reviewer_model: str = "google/gemini-2.0-flash"
    refiner_model: str = "google/gemini-2.0-flash"
...
class Module2Config:
    ...
    analyzer_model: str = "google/gemini-2.0-flash"
...
class Module3Config:
    ...
    tasks: list[str] = field(
        default_factory=lambda: ["deduplication", "noise_reduction", "importance_ranking"]
    )
