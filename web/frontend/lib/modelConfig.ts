...
export const MODEL_PROVIDERS: ProviderGroup[] = [
    ...
    },
    {
        ...
        icon: '🟠',
        models: [
            { id: 'anthropic/claude-opus-4-5-20251124', name: 'Claude Opus 4.5', isNew: true, isPro: true },
            { id: 'anthropic/claude-sonnet-4-5-20250929', name: 'Claude Sonnet 4.5' },
            { id: 'anthropic/claude-haiku-4-5-20251001', name: 'Claude Haiku 4.5' },
            { id: 'anthropic/claude-opus-4-20250514', name: 'Claude Opus 4', isPro: true },
    ...
    },
    {
        ...
        icon: '🔵',
        models: [
            { id: 'google/gemini-3-flash-preview', name: 'Gemini 3 Flash', isNew: true },
            { id: 'google/gemini-3-pro-preview', name: 'Gemini 3 Pro', isPro: true },
    ...
    },
    {
        ...
        models: [
            ...
            { id: 'deepseek/deepseek-reasoner', name: 'DeepSeek Reasoner', isNew: true },
...
export const MODEL_OPTIONS: FlatModelOption[] = MODEL_PROVIDERS.flatMap(provider =>
